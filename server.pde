...
void commentGet() {
  ...
  if (c != null) { // クライアントからデータが来ている
    ...
    else if (s.equals("down") == true || s.equals("した") == true || s.equals("下") == true) { 
      println("ok_down");
      chara.move("down");
    } 
    else if (s.equals("left") == true || s.equals("ひだり") == true || s.equals("左") == true) { 
      println("ok_left");
      chara.move("left");
      return;
    } 
    else if (s.equals("right") == true || s.equals("みぎ") == true || s.equals("右") == true) { 
      println("ok_right");
      chara.move("right");
    }
  }
